...
namespace BrainAI.BioAI
{
    ...
    public static class BioClusters
    {
        ...
        // Vokabular (Thread-Safe Dictionary)
        ...
        /// <summary>
        /// Erstellt ein deterministisches Token (FNV-1a Hash).
        /// </summary>
    ...
    public class BioBrain : IDisposable
    {
        ...
        /// <summary>
        /// Erstellt ein neues, leeres Gehirn.
        /// </summary>
        public BioBrain(ulong licenseKey)
        {
            ...
            {
                throw new Exception($"CRITICAL: Native library '{NativeMethods.LibName}' not found. Please rename 'BioAI_Ultra.dll' (or IoT/SmartHome) to 'bioai.dll' and place it in the plugins folder.\nDetails: {ex.Message}");
            }
        ...
        // Privater Konstruktor für Deserialisierung (vermeidet Overhead)
        ...
        public byte[] Serialize()
        {
            ...
            // WICHTIG: C-Buffer freigeben, sonst Memory Leak!
        ...
        public static BioBrain Deserialize(byte[] data)
        {
            ...
            // Wir müssen den Buffer in unmanaged Memory kopieren, damit C ihn lesen kann
            ...
            try
            {
                ...
                // Effizient: Direktes Wrappen des Pointers
    ...
    {
        // Unity sucht automatisch nach Plugins/bioai.dll (Windows) oder libbioai.so (Android/Linux)
        // Du musst deine 'BioAI_Ultra.dll' in 'bioai.dll' umbenennen!
